...
class MahasiswaController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $mhsModel = Mahasiswa::where('Nim', (int) $user->username)->first();
        $mhs = $mhsModel ?? (object)[
    ...
    public function updateBiodata(Request $request, $id)
    {
        ...
        if ((int)$mhs->Nim !== (int)$request->Nim) {
    ...
    public function gantiPassword(Request $request)
    {
        ...
        Mahasiswa::where('Nim', (int) $user->username)->update(['Sandi' => $userModel->password]);
